...
import com.unity3d.plugin.downloader.p006b.C0973p;
...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
        ...
        if (str == null) {
            ...
            while (i < i2) {
                ...
                if (charAt < 128) {
                    ...
                    if (charAt < 2048) {
                        writeByte((charAt >> 6) | C0973p.STATUS_RUNNING);
    ...
    public Buffer writeUtf8CodePoint(int i) {
        if (i < 128) {
            ...
            writeByte((i >> 6) | C0973p.STATUS_RUNNING);
            writeByte((i & 63) | 128);
        } else if (i < 65536) {
            if (i < 55296 || i > 57343) {
                writeByte((i >> 12) | 224);
    ...
    private ByteString digest(String str) {
        try {
            ...
            return ByteString.m999of(instance.digest());
    ...
    private ByteString hmac(String str, ByteString byteString) {
        try {
            ...
            return ByteString.m999of(instance.doFinal());
        } catch (NoSuchAlgorithmException unused) {
            throw new AssertionError();
