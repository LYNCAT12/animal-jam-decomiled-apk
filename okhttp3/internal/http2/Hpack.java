...
final class Hpack {
    ...
    static {
        ...
        headerArr[3] = new Header(Header.TARGET_PATH, Constants.URL_PATH_DELIMITER);
        ...
        headerArr[45] = new Header(WebPreferenceConstants.LOCATION, "");
    ...
    static final class Reader {
        ...
        public ByteString readByteString() throws IOException {
            ...
            if (z) {
                return ByteString.m999of(Huffman.get().decode(this.source.readByteArray((long) readInt)));
            }
