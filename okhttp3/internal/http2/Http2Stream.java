...
public final class Http2Stream {
    ...
    public boolean isLocallyInitiated() {
        if (this.connection.client == ((this.f1936id & 1) == 1)) {
            return true;
        }
        return false;
    }
    ...
    public synchronized java.util.List<okhttp3.internal.http2.Header> getResponseHeaders() throws java.io.IOException {
        /*
            r2 = this;
            monitor-enter(r2)
            okhttp3.internal.http2.Http2Stream$StreamTimeout r0 = r2.readTimeout     // Catch:{ all -> 0x002e }
            r0.enter()     // Catch:{ all -> 0x002e }
        L_0x0006:
            java.util.List<okhttp3.internal.http2.Header> r0 = r2.responseHeaders     // Catch:{ all -> 0x0027 }
            if (r0 != 0) goto L_0x0012
            okhttp3.internal.http2.ErrorCode r0 = r2.errorCode     // Catch:{ all -> 0x0027 }
            if (r0 != 0) goto L_0x0012
            r2.waitForIo()     // Catch:{ all -> 0x0027 }
            goto L_0x0006
        L_0x0012:
            okhttp3.internal.http2.Http2Stream$StreamTimeout r0 = r2.readTimeout     // Catch:{ all -> 0x002e }
            r0.exitAndThrowIfTimedOut()     // Catch:{ all -> 0x002e }
        ...
        L_0x001f:
            ...
            okhttp3.internal.http2.ErrorCode r1 = r2.errorCode     // Catch:{ all -> 0x002e }
            r0.<init>(r1)     // Catch:{ all -> 0x002e }
            throw r0     // Catch:{ all -> 0x002e }
        L_0x0027:
            r0 = move-exception
            okhttp3.internal.http2.Http2Stream$StreamTimeout r1 = r2.readTimeout     // Catch:{ all -> 0x002e }
            r1.exitAndThrowIfTimedOut()     // Catch:{ all -> 0x002e }
            throw r0     // Catch:{ all -> 0x002e }
        L_0x002e:
            r0 = move-exception
            monitor-exit(r2)
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: okhttp3.internal.http2.Http2Stream.getResponseHeaders():java.util.List");
    }
    ...
    public void reply(List<Header> list, boolean z) throws IOException {
        ...
        this.connection.writeSynReply(this.f1936id, z2, list);
        if (z2) {
    ...
    public void close(ErrorCode errorCode2) throws IOException {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynReset(this.f1936id, errorCode2);
        }
    }

    public void closeLater(ErrorCode errorCode2) {
        if (closeInternal(errorCode2)) {
            this.connection.writeSynResetLater(this.f1936id, errorCode2);
        }
    }
    ...
    private boolean closeInternal(ErrorCode errorCode2) {
        synchronized (this) {
            ...
            notifyAll();
            this.connection.removeStream(this.f1936id);
            return true;
        }
    }
    ...
    private final class FramedDataSource implements Source {
        ...
        public long read(okio.Buffer r8, long r9) throws java.io.IOException {
            ...
            L_0x001d:
                ...
                int r3 = r3.f1936id     // Catch:{ all -> 0x009b }
    ...
    final class FramedDataSink implements Sink {
        ...
        private void emitDataFrame(boolean z) throws IOException {
            ...
            Http2Stream.this.writeTimeout.enter();
            try {
                Http2Stream.this.connection.writeData(Http2Stream.this.f1936id, z && min == this.sendBuffer.size(), this.sendBuffer, min);
            } finally {
                Http2Stream.this.writeTimeout.exitAndThrowIfTimedOut();
            }
        }
        ...
        /* JADX WARNING: Code restructure failed: missing block: B:15:0x002d, code lost:
            r8.this$0.connection.writeData(r8.this$0.f1936id, true, (okio.Buffer) null, 0);
         */
